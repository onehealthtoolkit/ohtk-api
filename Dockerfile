...
# S3-compatible (MinIO): set at runtime — AWS_S3_ENDPOINT_URL, AWS_S3_CUSTOM_DOMAIN,
# AWS_S3_ADDRESSING_STYLE, AWS_S3_USE_SSL, AWS_DEFAULT_ACL, AWS_QUERYSTRING_AUTH
