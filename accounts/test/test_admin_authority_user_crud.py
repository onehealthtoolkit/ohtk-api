...
class AdminAuthorityUserTests(JSONWebTokenTestCase):
    ...
    def test_create_with_error(self):
        mutation = """
        mutation adminAuthorityUserCreate($authorityId: Int!, $username: String!, $firstName: String!, $lastName: String!, $email: String!, $telephone: String) {
            adminAuthorityUserCreate(authorityId: $authorityId, username: $username, firstName: $firstName, lastName: $lastName, email: $email, telephone: $telephone) {
                result {
                  __typename
